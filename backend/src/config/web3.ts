...
// Contract addresses
export const U2K_TOKEN_ADDRESS = process.env.U2K_TOKEN_ADDRESS || '';
export const BILL_PAYMENT_SYSTEM_ADDRESS = process.env.BILL_PAYMENT_SYSTEM_ADDRESS || '';

// RPC Provider URL - default to Sepolia testnet if not specified
export const RPC_PROVIDER_URL = process.env.RPC_PROVIDER_URL || 'https://sepolia.infura.io/v3/YOUR_INFURA_KEY';

// Chain ID - default to Sepolia testnet if not specified (Chain ID 11155111)
export const CHAIN_ID = parseInt(process.env.CHAIN_ID || '11155111');
